# SSH2DOS v0.2.1+SHA256.1+ed25519+curve25519-sha256 +CP437/UTF-8 Compatibility
patch by Al's Geek Lab 2026/03/08
https://github.com/ajrossnz/ssh2dos

This update adds compatibility for DOS based CP437 computers and Unicode
(i.e. if you are connecting to a Linux machine that is a modern UTF-8 codepage,
it translates to CP437 to display a lot better )

## Screenshots of before and after
![with Unicode to cp437 conversion](after.jpg)
![without Unicode to cp437 conversion](before.jpg)
----------------------

SSH2DOS v0.2.1+SHA256.1+ed25519+curve25519-sha256 by Toyoyo
https://github.com/Toyoyo/ssh2dos
Released on 02-07-2026

Toyo Added:
- AI-generated ssh-ed25519 for HostKeyAlgorithm
- AI-generated curve25519-sha256 for KexAlgorithm
...
COPYRIGHT 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴
...
INTRODUCTION 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴�
...
INSTALLATION 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴�
...
DOCUMENTATION 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴

	To get help for SSH2DOS and SFTPDOS, please use the /? command
	line option.

  -U switch off UTF-8 to CP437 mapping 
...
EXAMPLES컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴
...
OFFICIAL SITE 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴
